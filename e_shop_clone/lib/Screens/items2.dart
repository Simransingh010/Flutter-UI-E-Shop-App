...
class ItemScreen2 extends StatefulWidget {
  ...
  @override
  State<ItemScreen2> createState() => _ItemScreenState();
}

class _ItemScreenState extends State<ItemScreen2> {
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        snapshot.data![index]['title'].length > 30
                            ? '${snapshot.data![index]['title'].substring(0, 30)}...'
